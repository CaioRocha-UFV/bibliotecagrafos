...
public class Christofides {
    ...
    public static ArrayList<Vertice>  Christofides(Grafo grafo){
     ...
     */
        ...
        System.out.println("Ter certeza que finalizou corretamente");
        //for (int y = 0; y < resultado.size()-1; y++){
        //    System.out.println("Veri: " + resultado.get(y).getIndex() + " - " + resultado.get(y+1).getIndex());
       // }
         */
        return resultado;
    }
